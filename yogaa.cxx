...
int main() {
    ...
    while (login_attempt < 3) {
        ...
        if (input_pin == pin) {
                ...
                switch (choice) {
                    ...
                    case 3:
                        ...
                        if (withdrawal_amount > balance) {
                            ...
                            printf("Penarikan Sukses.  Sisa Saldo Kamu Saat Ini Adalah: %.2f\n", balance);
                        }
                        break;
                    case 4:
                        ...
                        if (transfer_amount > balance) {
                            ...
                            printf("Transfer Sukses.  Sisa Saldo Kamu Saat Ini Adalah: %.2f\n", balance);
                        }
                        break;
                    case 5:
                        printf("Top up menu\n");
                        ...
                        switch (top_up_choice) {
                            case 1:
                                ...
                                printf("Masukkan PIN: ");
                                scanf("%d", &pin);
                                printf("Top up Berhasil.  Sisa Saldo Kamu Saat Ini Adalah: %.2f\n", balance + top_up_dana);
                                break;
                            case 2:
                                printf("Masukkan Jumlah Top Up: ");
                                ...
                                printf("Masukkan PIN: ");
                                scanf("%d", &pin);
                                printf("Top Up Berhasil.  Sisa Saldo Anda Saat Ini Adalah: %.2f", balance += top_up_gopay);
                                printf("Top Up Berhasil. Sisa Saldo Kamu Saat Ini Adalah: %.2f\n", balance);
                                break;
                            default:
            ...
            printf("PIN Salah. Silahkan Coba Kembali.\n");
            login_attempt++;
        }
    }
    // Jika sudah 3 kali percobaan login dan masih gagal, keluar dari program
    if (login_attempt == 3) {
        printf("Terlalu Banyak Usaha Yang Dilakukan . ATM Terblokir.\n");
    }
    return 0;
}